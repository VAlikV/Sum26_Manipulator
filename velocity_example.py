...
trajectory_steps = int(np.ceil((10.0) / env.sim_dt)) + 1
...
for i in range(trajectory_steps):
    ...
    sample = planner.sample(t_sec)

    if sample is not None:
        planned_pos, planned_vel = sample
        joint_target[0:6] = planned_pos
